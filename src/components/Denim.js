...
componentDidMount() {
  axios.get(`/api/get_products/Denim`).then( response => {
...
getOtherProducts() {
  ...
  axios.get(`/api/get_other_products/Denim/${offset}`).then( otherProductsResponse => {
...
export default withRouter(connectedApp(Denim));